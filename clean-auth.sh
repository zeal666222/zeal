...
# ═══════════════════════════════════════════════════════════════════════════════
# Replaces all auth pages with calm, high-end designs:
#   • No terminal / cyberpunk / "God-View" aesthetic
#   • Soft glassmorphism, generous spacing, muted accents
#   • Visible register + apply everywhere
# ═══════════════════════════════════════════════════════════════════════════════
...
TS="$(date +%Y%m%d-%H%M%S)"
ARCHIVE="_archive/clean-auth-${TS}"
mkdir -p "$ARCHIVE"
E=0
...
echo "═══ ZEAL — RELAXED PREMIUM AUTH ═══"

# ═══════════════════════════════════════════════════════════════════════════════
# 1/5 — apps/admin/app/login/page.tsx  (calm, premium admin)
# ═══════════════════════════════════════════════════════════════════════════════
backup apps/admin/app/login/page.tsx
mkdir -p apps/admin/app/login
cat > apps/admin/app/login/page.tsx << 'ADMIN'
"use client";
...
ADMIN
echo "[OK] 1/5 admin login"

# ═══════════════════════════════════════════════════════════════════════════════
# 2/5 — apps/web/app/login/page.tsx
# ═══════════════════════════════════════════════════════════════════════════════
backup apps/web/app/login/page.tsx
cat > apps/web/app/login/page.tsx << 'WEBLOGIN'
"use client";
...
WEBLOGIN
echo "[OK] 2/5 web login"

# ═══════════════════════════════════════════════════════════════════════════════
# 3/5 — apps/web/app/register/page.tsx
# ═══════════════════════════════════════════════════════════════════════════════
backup apps/web/app/register/page.tsx
cat > apps/web/app/register/page.tsx << 'WEBREG'
"use client";
...
WEBREG
echo "[OK] 3/5 web register"

# ═══════════════════════════════════════════════════════════════════════════════
# 4/5 — apps/web/app/consultant/login/page.tsx
# ═══════════════════════════════════════════════════════════════════════════════
backup apps/web/app/consultant/login/page.tsx
mkdir -p apps/web/app/consultant/login
cat > apps/web/app/consultant/login/page.tsx << 'CLOGIN'
"use client";
...
CLOGIN
echo "[OK] 4/5 consultant login"

# ═══════════════════════════════════════════════════════════════════════════════
# 5/5 — apps/web/app/consultant/register/page.tsx
# ═══════════════════════════════════════════════════════════════════════════════
backup apps/web/app/consultant/register/page.tsx
mkdir -p apps/web/app/consultant/register
cat > apps/web/app/consultant/register/page.tsx << 'CREG'
"use client";
...
CREG
echo "[OK] 5/5 consultant register"
...
echo ""
echo "Commit + push:"
echo '  git commit -m "Relaxed premium auth: all 5 pages redesigned"'
echo "  git pull --rebase origin main 2>/dev/null || git pull origin main"
