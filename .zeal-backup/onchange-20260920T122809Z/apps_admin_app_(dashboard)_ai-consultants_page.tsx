...
import {
  Sparkles, Loader2, Wifi, Search, Plus, Edit3, Trash2, X, Save, Check,
} from "lucide-react";
            ...
            <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }}
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea value={form.bio} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setForm({ ...form, bio: e.target.value })}
                ...
                <div>
                  ...
                  <textarea value={form.systemPrompt ?? ""} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setForm({ ...form, systemPrompt: e.target.value })}
