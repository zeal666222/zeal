    ...
    <div className="space-y-6">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-3">
          {filtered.map((c) => (
            <div key={c.id} className="flex items-center gap-4 p-4 bg-slate-900/60 backdrop-blur-xl border border-white/5 rounded-2xl hover:border-purple-500/20 transition-all">
