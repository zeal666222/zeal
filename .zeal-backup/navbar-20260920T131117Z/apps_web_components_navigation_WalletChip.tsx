"use client";
// ═══════════════════════════════════════════════════════════════════════════════
// WalletChip — realtime balance with animated delta
// ─────────────────────────────────────────────────────────────────────────────
// Subscribes to channels.userWallet(uid). Shows a floating +N / -N badge when
// balance changes. Animated colour flash on credit vs debit.
// ═══════════════════════════════════════════════════════════════════════════════
...
export function WalletChip({ userId, initialBalance, className }: Props) {
  ...
  const Icon = flash === "up" ? TrendingUp : flash === "down" ? TrendingDown : IndianRupee;
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        flash === "up" && "border-emerald-500/40 shadow-[0_0_20px_-4px_rgb(16_185_129/0.5)]",
        flash === "down" && "border-rose-500/40 shadow-[0_0_20px_-4px_rgb(244_63_94/0.5)]",
