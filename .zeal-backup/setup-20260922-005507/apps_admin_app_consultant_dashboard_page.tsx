...
import { Activity, Calendar, ChevronRight, Flame, IndianRupee, Loader2, MessageCircle,
  Power, Radio, Sparkles, Star, Users, Wallet } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <div className="rounded-3xl border border-[var(--color-primary)]/20 bg-[var(--color-surface)] p-6 min-h-[360px]">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-black text-[var(--color-foreground)] flex items-center gap-2">
        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
            <h2 className="text-xs font-black uppercase tracking-widest text-[var(--color-muted-foreground)] mb-4 flex items-center gap-2">
