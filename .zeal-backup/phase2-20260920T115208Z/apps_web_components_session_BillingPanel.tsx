"use client";
// ═══════════════════════════════════════════════════════════════════════════════
// BillingPanel — live session timer + cost display + terminate warning
// ═══════════════════════════════════════════════════════════════════════════════
// Drives the server-authoritative billing heartbeat every 30s.
// Uses only server-returned values for cost + remaining balance.
// ═══════════════════════════════════════════════════════════════════════════════
...
export function BillingPanel({ sessionId, rate, onEnd, onTerminated }: Props) {
  ...
  // Local 1-second counter for smooth UI
  useEffect(() => {
