      ...
      <div className="max-w-4xl mx-auto px-4 -mt-16 md:-mt-20 relative z-10">
        ...
        <div className="mb-4 flex items-center gap-4 border-b border-white/5">
          <button
            ...
            className={`pb-3 text-sm font-bold uppercase tracking-wider border-b-2 ${
              tab === "posts" ? "text-white border-[#9D7DC5]" : "text-slate-400 border-transparent"
            }`}
          >
            Posts ({posts.length})
          </button>
          <button
            ...
            className={`pb-3 text-sm font-bold uppercase tracking-wider border-b-2 ${
              tab === "reviews" ? "text-white border-[#9D7DC5]" : "text-slate-400 border-transparent"
            }`}
          >
