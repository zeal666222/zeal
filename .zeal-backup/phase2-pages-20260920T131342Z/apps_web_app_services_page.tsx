...
// ═══════════════════════════════════════════════════════════════════════════════
// Services Hub — Suspense-streamed stats + AI search hero
// ═══════════════════════════════════════════════════════════════════════════════
...
export const metadata = {
  ...
  description:
    "AI-powered search across astrology, tarot, therapy, numerology, palmistry, and 30+ more traditions.",
};
...
async function StatsBar() {
  ...
  const totalCategories = Object.keys(CATEGORY_ID_TO_NAME).length;
...
function StatsSkeleton() {
  return (
    <div className="flex flex-wrap items-center gap-6 mb-8 animate-pulse">
      {[1, 2, 3].map((i) => (
        <div key={i} className="h-8 w-32 rounded bg-slate-800" />
      ))}
    </div>
  );
}
