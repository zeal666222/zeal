#!/usr/bin/env bash
# ZEAL - Middleware Token Race Condition Fix

WEB_MW_PATH="apps/web/middleware.ts"

echo "Applying Enterprise Supabase Middleware Fix to $WEB_MW_PATH..."
...
echo "✅ Middleware rewritten successfully."
echo "⚠️ IMPORTANT: Restart your Next.js development server to apply the changes."