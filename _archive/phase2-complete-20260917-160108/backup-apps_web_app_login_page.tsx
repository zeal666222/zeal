...
import { Sparkles, Loader2, Mail, Lock, ShieldCheck } from "lucide-react";
...
export default function LoginPage() {
  return (
    <div className="min-h-screen-app flex items-center justify-center p-4 relative overflow-hidden bg-slate-950">
      ...
      {/* 
        The Suspense Boundary is strictly required here to prevent Next.js from throwing 
        a runtime crash when useSearchParams() is executed on the client. 
      */}
      <Suspense fallback={
