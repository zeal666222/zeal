...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#533AFD] via-[#9D7DC5] to-[#533AFD] p-4 py-12">
      <motion.div
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 text-sm">Create your account to begin</p>
        </div>
        ...
        <div className="rounded-3xl p-6 md:p-8 backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl">
          ...
          <div className="text-center text-sm text-white/60 mt-5">
            ...
            <Link href="/auth/login" className="text-[#9D7DC5] hover:underline font-medium">Sign in</Link>
          </div>
        </div>
